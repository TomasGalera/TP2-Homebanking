...
class Client {
    constructor(dni, password, clientName, clientSurname, limit, debitCardNumber, habilitacion){
        this.id = clientId;
        this.dni = dni;
        ...
        this.cards = [{cardNumber: debitCardNumber, cardExpiration: new Date(currentDate.getFullYear() + 3, currentDate.getMonth(), currentDate.getDate())}];
